      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="max-w-2xl mb-16 lg:mb-24 reveal-up">
          ...
          <p className="text-moss text-lg font-light leading-relaxed">
            You&apos;ve tried biotin. You&apos;ve Googled at 2am. You&apos;ve been told &ldquo;it&apos;s just stress&rdquo; by a GP who spent four minutes on your concern. What you haven&apos;t had yet is someone who actually looked.
          </p>
        </div>
