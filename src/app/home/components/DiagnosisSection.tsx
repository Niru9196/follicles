...
const steps = [
  ...
  },
  {
    ...
    body: 'You leave knowing exactly what type of loss you have, what&apos;s causing it, and what your realistic regrowth timeline looks like. No vague &ldquo;stress and diet&rdquo; — specific causes, specific protocols.',
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="text-center max-w-2xl mx-auto mb-20 reveal-up">
          ...
          <h2 className="font-serif text-evergreen leading-tight mb-5" style={{ fontSize: 'clamp(2rem, 4vw, 3.4rem)' }}>
            &ldquo;Let me look&rdquo; —<br />
            <em>not &ldquo;have you tried.&rdquo;</em>
          </h2>
